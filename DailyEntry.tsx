...
const DailyEntry: React.FC<DailyEntryProps> = ({ log, onUpdate, customSunnahs = [] }) => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* NEW FEATURE: Supplication Aloud (يجأرون بالدعاء) */}
      <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl p-6 shadow-xl text-white relative overflow-hidden group">
        <div className="absolute top-0 left-0 w-full h-full bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
